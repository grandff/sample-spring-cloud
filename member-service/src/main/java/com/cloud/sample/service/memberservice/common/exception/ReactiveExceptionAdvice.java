package com.cloud.sample.service.memberservice.common.exception;
...
import com.cloud.sample.service.memberservice.common.dto.ErrorResponse;
...
public class ReactiveExceptionAdvice {
    ...
    protected Mono<ResponseEntity<ErrorResponse>> handleCommonMessageException(CommonMessageException e) {
        log.error("handleCommonMessageException", e);
    ...
    /**
     * 개발자 정의 ErrorCode 를 처리하는 Custom RuntimeException Handler
     * 개발자가 만들어 던지는 런타임 오류를 처리
     *
     * @param e
     * @return ResponseEntity<ErrorResponse>
    ...
    protected Mono<ResponseEntity<ErrorResponse>> handleCommonException(CommonException e) {
